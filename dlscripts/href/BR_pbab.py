...
for fhour in range(0,31):
	...
	reflect_pb_ab[reflect_pb_ab>1000000] = np.nan
	reflect_pb_ab[reflect_pb_ab>60] = 60.0

	im = m.imshow(reflect_pb_ab,zorder=2,cmap='tab10',interpolation='none',vmin=1,vmax=10)
	plt.box(False)
	pbfil = '/gpfs_backup/stormtrack/jtradfor/ensemble_data/wxenviz.github.io/uploads/outimages/href/%s%s00_BR_pbab.png' % (datesub,str(fhour).zfill(2))
