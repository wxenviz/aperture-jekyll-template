...
totalPrecips_ab[totalPrecips_ab>20.0] = 20.0

im = m.imshow(totalPrecips_ab,zorder=2,aspect='equal',interpolation='none',cmap='jet',vmin=0.0,vmax=20.0)
...
plt.box(False)
sdfil = '/gpfs_backup/stormtrack/jtradfor/ensemble_data/wxenviz.github.io/uploads/outimages/sref/%s_apcp_ab.png' % (forecasthoursub)
