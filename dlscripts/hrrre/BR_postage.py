...
def BRpostage(reflectivities,outname):
    ...
    postagefil = '/gpfs_backup/stormtrack/jtradfor/ensemble_data/wxenviz.github.io/uploads/outimages/hrrre/' + outname + '_BR_postage.png'
    plt.savefig(postagefil,facecolor='#101010',bbox_inches='tight',dpi=300)
    plt.close()
...
if len(datapaths)>0:
	...
	pbsdfil = BRpostage(reflectivities,fil)

f = open("/gpfs_backup/stormtrack/jtradfor/ensemble_data/wxenviz.github.io/dlscripts/hrrre/unlock/BRpostage.unlock","w+")
