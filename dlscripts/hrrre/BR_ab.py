...
def BRab(reflectivities,outname):
    ...
    plt.box(False)
    sdfil = '/gpfs_backup/stormtrack/jtradfor/ensemble_data/wxenviz.github.io/uploads/outimages/hrrre/' + outname + '_BR_ab.png'
...
if len(datapaths)>0:
	...
	pbsdfil = BRab(reflectivities,fil)
