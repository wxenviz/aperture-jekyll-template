...
def ens_mean(reflectivities,outname):
    ...
    plt.box(False)
    meanfil = '/gpfs_backup/stormtrack/jtradfor/ensemble_data/wxenviz.github.io/uploads/outimages/hrrre/' + outname + '_R_mean.png'
...
if len(datapaths)>0:
	...
	pbsdfil = ens_mean(reflectivities,fil)
